...
export class PagingComponent {
  ...
  public currentAmountShiftedInPx:number = 0;
  public initialized:boolean = false;
  public ignoreFirst:boolean = true;

  constructor(@Host() host:Content, public ngZone:NgZone, public viewController:ViewController) {
